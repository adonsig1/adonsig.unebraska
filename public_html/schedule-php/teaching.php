<?php
	...
	if ( isset($_REQUEST['action']) && ($_REQUEST['action'] == 'ajax_update') ) {
		do_ajax_update();	
		return;
	}
...
<html>
	...
	function do_ajax_update() {
		global $fall, $spr, $newconn;
		
		header("Content-Type: text/plain");
		
		$id = mysqli_real_escape_string($newconn, $_REQUEST['id']);
		$fall_crhr = mysqli_real_escape_string($newconn, $_REQUEST['fall_crhr']);
		$fall_comments = mysqli_real_escape_string($newconn, $_REQUEST['fall_comments']);
		$spr_crhr = mysqli_real_escape_string($newconn, $_REQUEST['spr_crhr']);
		$spr_comments = mysqli_real_escape_string($newconn, $_REQUEST['spr_comments']);

		mysqli_query($newconn, "BEGIN");
		...
		mysqli_query($newconn, $delete);
		mysqli_query($newconn, $insert);
